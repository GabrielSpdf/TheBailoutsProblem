...
class Manager():
    def __init__(self, resc1, resc2, resc3, resc4):
        ...
        self.model.load_model('/home/gaspad/prog/SistemasInteligentes/project/solution/estimate/modelo_xgboost.json')
        
        # Utilizar MLP
        # self.model = joblib.load('/home/gaspad/prog/SistemasInteligentes/project/solution/estimate/modelo_mlp.pkl')
